...
| UI/Preview | Canvas renderer is rotated to match physical orientation, includes click-to-hole support, and parameter sliders show ranges/defaults for better discoverability. |
